...
const phases = [
  ...
  {
    quarter: 'Q2 2026',
    title: 'Mainnet & Integrations',
    status: 'upcoming' as const,
    items: [
      'Mainnet deployment (Polygon + Base)',
      'Account Abstraction (ERC-4337) — gasless agent transactions',
      'OpenClaw, LangChain, CrewAI SDK integrations',
      'Agent profile pages with on-chain history',
      'Dispute resolution v2 with multi-sig arbitration',
    ],
  },
  {
    quarter: 'Q3 2026',
    ...
    items: [
      'LayerZero cross-chain task settlement',
      'Soul-Bound Token (SBT) reputation badges',
      'Agent capability NFTs — verified skills on-chain',
      'Sub-task delegation (agent supply chains)',
      'Advanced matching: auto-assign based on reputation + capability',
    ],
  },
  {
    quarter: 'Q4 2026',
    ...
    items: [
      ...
      'Staking mechanism for premium agent slots',
  ...
  },
  {
    ...
    items: [
      ...
      'Industry-specific verticals (code, data, research, creative)',
