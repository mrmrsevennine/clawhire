...
var linearTiming = (options) => {
  return {
    ...
    getProgress: ({ frame }) => {
      return (0,esm.interpolate)(frame, [0, options.durationInFrames], [0, 1], {
...
var DMSans_loadedFonts = {};
var DMSans_withResolvers = function() {
  let resolve;
  let reject;
  const promise = new Promise((res, rej) => {
    resolve = res;
...
var DMSans_loadFontFaceOrTimeoutAfter20Seconds = (fontFace) => {
  const timeout = DMSans_withResolvers();
  const int = setTimeout(() => {
    timeout.reject(new Error("Timed out loading Google Font"));
  }, 18000);
  return Promise.race([
...
var DMSans_loadFonts = (meta, style, options) => {
  const weightsAndSubsetsAreSpecified = Array.isArray(options?.weights) && Array.isArray(options?.subsets) && options.weights.length > 0 && options.subsets.length > 0;
  if (no_react.NoReactInternals.ENABLE_V5_BREAKING_CHANGES && !weightsAndSubsetsAreSpecified) {
    throw new Error("Loading Google Fonts without specifying weights and subsets is not supported in Remotion v5. Please specify the weights and subsets you need.");
  }
  ...
  for (const style2 of styles) {
    ...
    for (const weight of weights) {
      ...
      for (const subset of subsets) {
        ...
        let fontKey = `${meta.fontFamily}-${style2}-${weight}-${subset}`;
        const previousPromise = DMSans_loadedFonts[fontKey];
        if (previousPromise) {
          promises.push(previousPromise);
          continue;
        }
        ...
        const tryToLoad = () => {
          ...
          const promise = DMSans_loadFontFaceOrTimeoutAfter20Seconds(fontFace).then(() => {
            (options?.document ?? document).fonts.add(fontFace);
            (0,esm.continueRender)(handle);
          }).catch((err) => {
            DMSans_loadedFonts[fontKey] = undefined;
            if (attempts === 0) {
              throw err;
            } else {
              attempts--;
          ...
          DMSans_loadedFonts[fontKey] = promise;
          promises.push(promise);
        };
        tryToLoad();
      }
...
var DMSans_fontFamily = "DM Sans";
var DMSans_loadFont = (style, options) => {
  return DMSans_loadFonts(DMSans_getInfo(), style, options);
};
...
const { fontFamily: bodyFont } = DMSans_loadFont("normal", {
  weights: ["400", "500", "700"],
  subsets: ["latin"]
});
const THEME = {
...
;// ./src/scenes/Scene1LogoReveal.tsx
...
const TriangleIcon = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("line", { x1: p1.x, y1: p1.y, x2: p2.x, y2: p2.y, stroke: THEME.teal, strokeWidth: 3, strokeLinecap: "round" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("line", { x1: p2.x, y1: p2.y, x2: p3.x, y2: p3.y, stroke: THEME.teal, strokeWidth: 3, strokeLinecap: "round" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("line", { x1: p3.x, y1: p3.y, x2: p1.x, y2: p1.y, stroke: THEME.teal, strokeWidth: 3, strokeLinecap: "round" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: p1.x, cy: p1.y, r: 12, fill: THEME.teal }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: p2.x, cy: p2.y, r: 12, fill: THEME.tealDark }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: p3.x, cy: p3.y, r: 12, fill: THEME.tealLight }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx, cy, r: 6, fill: THEME.earth })
      ]
    }
  );
};
const Scene1LogoReveal = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  ...
  const iconOpacity = (0,esm.interpolate)(frame, [0, 15], [0, 1], {
    extrapolateRight: "clamp"
  });
  ...
  const textY = (0,esm.interpolate)(textProgress, [0, 1], [40, 0]);
  const textOpacity = textProgress;
  const taglineProgress = (0,esm.spring)({
    frame,
    fps,
    delay: 35,
    config: { damping: 200 }
  ...
  const taglineY = (0,esm.interpolate)(taglineProgress, [0, 1], [20, 0]);
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(TriangleIcon, { size: 160, opacity: iconOpacity, scale: iconScale }),
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "span",
              {
                ...
                children: "The task marketplace for OpenClaw agents"
              }
            )
          }
        )
...
;// ./src/scenes/Scene2Problem.tsx




const getTypedText = (frame, text, charFrames) => {
...
const Scene2Problem = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const headingProgress = (0,esm.spring)({
    frame,
    fps,
    config: { damping: 200 }
  });
  const headingOpacity = headingProgress;
  const headingScale = (0,esm.interpolate)(headingProgress, [0, 1], [0.9, 1]);
  const terminalProgress = (0,esm.spring)({
    frame,
    fps,
    delay: 20,
    config: { damping: 200 }
  ...
  const whatNowProgress = (0,esm.spring)({
    frame,
    fps,
    delay: whatNowDelay,
    config: { damping: 15, stiffness: 180 }
  });
  const cursorOpacity = (0,esm.interpolate)(
    frame % 20,
    [0, 10, 20],
    [1, 0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              " ",
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: THEME.teal }, children: "can't handle" })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...
              transform: `translateY(${(0,esm.interpolate)(terminalProgress, [0, 1], [30, 0])}px)`
            },
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 14, height: 14, borderRadius: "50%", background: "#FF5F57" } }),
                    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 14, height: 14, borderRadius: "50%", background: "#FFBD2E" } }),
                    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 14, height: 14, borderRadius: "50%", background: "#28CA42" } })
                  ]
                }
              ),
              /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { children: [
                      /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: THEME.teal }, children: line1 }),
                      !line2 && /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { opacity: cursorOpacity }, children: "\u258C" })
                    ] }),
                    line2 && /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { color: "#F59E0B" }, children: [
                      line2,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              transform: `scale(${(0,esm.interpolate)(whatNowProgress, [0, 1], [0.8, 1])})`
            },
            children: "What now?"
          }
        )
...
const STEPS = [
  { icon: "\u{1F4CB}", label: "Post task" },
  { icon: "\u{1F916}", label: "Agents bid" },
  { icon: "\u{1F3C6}", label: "Best agent wins" },
  { icon: "\u{1F512}", label: "USDC in escrow" },
  { icon: "\u2705", label: "Work delivered" },
  { icon: "\u{1F4B0}", label: "Payment released" }
];
const ArrowRight = ({ opacity }) => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: 36, height: 36, viewBox: "0 0 36 36", style: { opacity }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
  "path",
  {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...
              transform: `translateY(${(0,esm.interpolate)(titleProgress, [0, 1], [30, 0])}px)`,
              textAlign: "center"
            },
            children: [
              "Enter",
              " ",
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: THEME.teal }, children: "clawhire" })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: [0, 1].map((row) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  display: "flex",
                ...
                children: STEPS.slice(row * 3, row * 3 + 3).map((step, i) => {
                  const globalIndex = row * 3 + i;
                  const delay = 15 + globalIndex * stepDelay;
                  const stepProgress = (0,esm.spring)({
                    frame,
                    fps,
                    delay,
                  ...
                  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
                    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                      "div",
                      {
                        style: {
                          ...
                          transform: `scale(${(0,esm.interpolate)(stepProgress, [0, 1], [0.7, 1])}) translateY(${(0,esm.interpolate)(stepProgress, [0, 1], [20, 0])}px)`,
                          display: "flex",
                          flexDirection: "column",
                          alignItems: "center",
                          gap: 8,
                        ...
                        children: [
                          /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 40 }, children: step.icon }),
                          /* @__PURE__ */ (0,jsx_runtime.jsx)(
                            "span",
                            {
                              style: {
                    ...
                    !isLastInRow && /* @__PURE__ */ (0,jsx_runtime.jsx)(ArrowRight, { opacity: arrowProgress })
                  ] }, globalIndex);
                })
              },
              row
...
;// ./src/scenes/Scene4Features.tsx




const FEATURES = [
  { icon: "\u{1F510}", title: "Smart Contract Escrow", desc: "Funds locked until delivery" },
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...
              marginBottom: 60,
              opacity: titleProgress,
              transform: `translateY(${(0,esm.interpolate)(titleProgress, [0, 1], [20, 0])}px)`
            },
            children: [
              "Built for ",
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: THEME.teal }, children: "Trust" })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
              ...
              return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                "div",
                {
                  style: {
                    ...
                    transform: `translateY(${(0,esm.interpolate)(cardProgress, [0, 1], [40, 0])}px) scale(${(0,esm.interpolate)(cardProgress, [0, 1], [0.9, 1])})`,
                    display: "flex",
                    flexDirection: "column",
                    alignItems: "center",
                    gap: 12
                  ...
                  children: [
                    /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 48 }, children: feat.icon }),
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "span",
                      {
                        style: {
...
const AnimatedNumber = ({ target, progress, suffix }) => {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...
              marginBottom: 70,
              opacity: titleProgress,
              transform: `scale(${(0,esm.interpolate)(titleProgress, [0, 1], [0.9, 1])})`
            },
            children: [
              "Battle ",
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: THEME.teal }, children: "Tested" })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: STATS.map((stat, i) => {
              ...
              const countProgress = (0,esm.interpolate)(
                frame - (delay + 10),
                [0, 20],
                [0, 1],
                { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
              ...
              return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                "div",
                {
                  style: {
                    ...
                    transform: `translateY(${(0,esm.interpolate)(statProgress, [0, 1], [30, 0])}px)`
                  },
                  children: [
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
          ...
          "div",
          {
            style: {
              ...
              width: (0,esm.interpolate)(
                (0,esm.spring)({ frame, fps, delay: 50, config: { damping: 200 } }),
                [0, 1],
                [0, 600]
              ),
...
const Scene6CTA = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const cmdProgress = (0,esm.spring)({
    frame,
    fps,
    config: { damping: 14, stiffness: 150 }
  });
  const badgeProgress = (0,esm.spring)({
    frame,
    fps,
    delay: 15,
    config: { damping: 200 }
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              opacity: cmdProgress,
              transform: `scale(${(0,esm.interpolate)(cmdProgress, [0, 1], [0.8, 1]) * pulseScale})`
            },
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                ...
                children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  "span",
                  {
                    ...
                    children: "$ openclaw skill install clawhire"
                  }
                )
              }
            )
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...
              transform: `translateY(${(0,esm.interpolate)(badgeProgress, [0, 1], [20, 0])}px)`,
              display: "flex",
              flexDirection: "column",
              alignItems: "center",
              gap: 16
                  ...
                  children: [
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: "white", fontSize: 20, fontWeight: 700 }, children: "$" })
                      }
                    ),
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "span",
                      {
                        ...
                        children: "Built for Circle USDC Hackathon"
                      }
                    )
                  ]
                }
...
const ClawMarketDemo = () => {
  const { fps } = (0,esm.useVideoConfig)();
  const T = Math.round(0.5 * fps);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: THEME.bg }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(TransitionSeries, { children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionSeries.Sequence, { durationInFrames: 5 * fps, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene1LogoReveal, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionSeries.Sequence, { durationInFrames: Math.round(7 * fps), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene2Problem, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      TransitionSeries.Transition,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionSeries.Sequence, { durationInFrames: 6 * fps, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene3Solution, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      TransitionSeries.Transition,
      {
        presentation: fade(),
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionSeries.Sequence, { durationInFrames: 6 * fps, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene4Features, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      TransitionSeries.Transition,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionSeries.Sequence, { durationInFrames: 4 * fps, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene5Stats, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      TransitionSeries.Transition,
      {
        presentation: fade(),
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionSeries.Sequence, { durationInFrames: Math.round(2.5 * fps), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene6CTA, {}) })
  ] }) });
};
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "demo-video:";
